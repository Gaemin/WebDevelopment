...
if(isset($_POST['email'])) {
    ...
    $email_to = "info@colorproject.biz";
    ...
    if(!isset($_POST['_name']) ||
        ...
        died('We are sorry, but there appears to be a problem with the form you submitted. Did you fill out the form in English? ');       
...
<!-- Favicons
    ================================================== -->
  <link rel="icon" type="image/png" href="../img/5cclogo.png" >
  <link href="../img/tablogo.png" rel="shortcut icon">
    <!-- Bootstrap -->
            ...
            <nav id="tf-menu" class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                      <a class="navbar-brand noItalics" ><div class="wiii"><img src="../img/cplogo.png"\ height="50" width="190"></div></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#tf-aboutus">About</a></li>
